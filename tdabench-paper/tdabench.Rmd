...
A persistent homology calculation of a uniformly distributed torus would reveal two large 1 dimensional features, which are the two circles defined by the major and minor radius. There would also be a large 2 dimensional feature representing the inner cavity of the torus. 
...
>>>>>>> b0e4d5a5d0dae77c2c3d74cfd4bdb3464c7ff4d0

\begin{figure}
  \centering
  \includegraphics[height=2.5in]{../Figures/Final_Figures/fig1.png}
  \caption{\textbf{Calculating persistent homology of a torus with three TDA libraries.}
  Average runtime (mean $\pm$ SD) for each TDA library (denoted by color) is plotted against point cloud size.
