...
Note, it is possible an algorithm will eventually be developed to enable alpha complex computation of higher dimensional data (limitation is computational rather than mathematical). 
