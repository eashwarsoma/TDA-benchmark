...
We specifically aim to characterize the computational performance (run time) and limits of persistent homology calculations between Rips complexes in the \CRANpkg{TDAstats} and \CRANpkg{TDA} R packages.
...
Rips complex memory more predictable, but alpha complex memory generally better (but what about Ripser?).
